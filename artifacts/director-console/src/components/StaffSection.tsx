 ...
 * hire should be able to hand it over. It lasts a week, and anyone who has
 * not yet chosen a password gets a "Send a new invitation" button in the list
 * below: the colleague who opens the email late should not have to be told to
 * use "I've forgotten my password" on their first day.
 */
